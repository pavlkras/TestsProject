...
public class Maintenance {
	...
	public String SearchProcessingPage(String category,	String levelOfDifficulty, Model model) {
		...
		try{
			...
			outResultText.append("<table><tr><th>N</th><th>Question</th><th>Category</th><th>Level of difficulty</th></tr>");
			////
			for (String questionLine : resultDB) {				
				String[] element = questionLine.split(IMaintenanceService.DELIMITER);
				outResultText.append("<tr onclick='test(" + element[0] + ")'>"// set id for click event
						+ "<td> "+ element[0]+ " </td>"// question id
						+ "<td> "+ element[1]+ " </td>"// question text
						+ "<td> "+ element[4]+ " </td>"// category
						+ "<td> "+ element[5]+ " </td></tr>");// level of difficulty
			}
			////
			...
			AutoInformationTextHTML(BuildingCategoryCheckBoxTextHTML());
			AutoGeneratedHTMLFormText.append("<p>No Selected Category");
		}
		return "MaintenanceUpdatePage";// return too page after action
	}
