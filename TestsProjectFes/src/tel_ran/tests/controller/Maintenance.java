...
public class Maintenance {
	...
	public String addFromFileProcessingPage(String textfromfile, Model model) {
		...
		try{		
			//--------------------- stub method now
			 actionRes = maintenanceService.FillDataBaseFromTextResource(res);
			//
			AutoInformationTextHTML(" Adding Questions is - " + actionRes);			
		} catch (Exception e) {			
			System.out.println("catch of creating from file questions in FES");
		} 
		}else{
			AutoInformationTextHTML(" Adding Questions is - " + actionRes);	// out text to Page
		}
	...
	public String ModuleForBuildingQuestions(String category, String nQuestions, Model model) {		
		...
		try{
			...
			AutoInformationTextHTML("your request: to build " + nQuestions	+ " questions made");		
		}catch(Exception e){
			AutoInformationTextHTML("your request: to build " + nQuestions	+ " questions failed");
