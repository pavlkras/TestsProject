...
app.directive('camera', function(CameraService) {
        ...
        //    template: '<div class="camera"><video class="camera" autoplay="" /><div ng-transclude></div></div>',
            template: '<h1 align = "center" id="message" ng-show="switchTextCamera">For testing need camera. Click "allow" in pop-up window for using your ca</h1>',
...
// If camera doesn't work of if camera block
                    var onFailure = function (err) {
                    	document.getElementById("message").innerHTML = '<h3 align="center">Your camera does not work, testing is impossible. Try to unblock camera in browser and to reload this page. </h3>';
                        console.log("Error !");
                       //console.error(err);
                    }
