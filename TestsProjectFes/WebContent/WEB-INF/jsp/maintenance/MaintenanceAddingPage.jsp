...
<body>
	...
	<form action="add_actions" method="post" id="addingForm" name="question_adding_form">
   
    	<!-- id of question (optional) -->
        <div>
            <label>Question Index Number</label>
            <input type="text" name="questionIndex" value="0">
 		</div>
        ...
        <div id="longdiv">
            <label>New Question Category</label>
        ...
        <div>
            ...
            <input type="text" name="languageName" placeholder="Java">
 		</div>
        ...
        <div>
            <label>Input number answers <br />
            on image</label>
            <input type="text" name="numberAnswersOnPicture" value="0">
 		</div>
        <!--
        ...
        <div>
			...
			type="submit" value="Add To DataBase" disabled>
 		</div>
        <div>
            <label>		
