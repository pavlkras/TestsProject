...
<body>
	...
	<div id="formCategory" class="formCategory">
		...
		<form action='moduleForBuildingQuestions'>
			...
			Abstract - &nbsp;<input type="checkbox" value="abstract" name="category">
			Attention - &nbsp;<input type="checkbox" value="attention" name="category">
			Quantative - &nbsp;<input type="checkbox" value="quantative" name="category">
