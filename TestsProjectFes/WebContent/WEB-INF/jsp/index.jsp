...
<body>
<a class="myButton" href='http://localhost:8080/TestsProjectFes/'>Reload Page</a>
<br>
Maintenance SignIn
<br>
...
Personal SignIn
<br>
<form action="PersonalActions">
user name: <input type="text" name="usernamep" size=50 /><br>
password: <input type="password" name="passwordp" size=50/><br>
<input type="submit" class="myButton" value="PUSH">
</form>
<br>
<p>Name NONE <br>Password NONE</p>
</body>
</html>